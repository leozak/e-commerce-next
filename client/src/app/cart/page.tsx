    ...
    <div className="flex flex-col gap-8 items-center justify-center mt-12">
      ...
      <div className="w-full flex flex-col lg:flex-row gap-16">
        ...
        <div className="w-full lg:w-7/12 shadow-lg border border-gray-100 p-8 rounded-lg flex flex-col gap-8">
          {activeStep === 1 ? (
              ...
              <div key={item.id} className="flex items-center justify-between">
                ...
                <div className="flex gap-8">
                  ...
                  <div className="flex flex-col justify-between">
                    ...
                    <p className="font-normal">R$ {item.price.toFixed(2)}</p>
                  </div>
                </div>
                {/* DELETE BUTTON */}
            ...
            <p className="text-sm text-gray-500">
              Por favor, preencha o formulário de entrega.
            </p>
          )}
        </div>
        {/* DETAILS */}
        <div className="w-full lg:w-5/12 shadow-lg border border-gray-100 p-8 rounded-lg flex flex-col gap-4 h-max">
          ...
          <div className="flex flex-col gap-4 text-sm">
            <div className="flex justify-between">
              <p className="text-gray-500">Desconto (10%)</p>
          ...
          {activeStep === 1 && (
            <button
              ...
              className="w-full bg-gray-800 hover:bg-gray-900 transition-all duration-300 text-white py-2 rounded-lg cursor-pointer flex items-center justify-center gap-2"
            >
              Continue
